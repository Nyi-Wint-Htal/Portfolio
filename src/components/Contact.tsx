...
function Contact() {
  return (
    <div className="h-294 bg-[radial-gradient(circle,#ffffff_0%,#d4d4d4_100%)] pt-35">
      <div className="flex flex-col items-center text-center">
        ...
        <form className="flex flex-col items-center text-center mt-32.5">
          <input
            required
            type=""
          ...
          <input
            type="submit"
            className="fontStyle border-r-2 border-l-2 py-0.5 px-10 font-semibold text-[15px] mt-10 uppercase"
          />
        </form>
      </div>
    </div>
